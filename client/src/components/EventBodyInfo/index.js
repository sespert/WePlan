...
function EventBodyInfo() 
{
  ...
  <div className="cards-list grid cols-lg-3 cols-md-2 cols-sm-2">
    ...
    <div className="card__content">
       <p className="card-desc" id="paragraph1">We plan team created this cool web site to reduce the work load of the event/conference manager by organizing, managing and displaying the event schedule,  to all the attendees. </p>
    </div>
  </div>
  ...
  <img className="cardimage1" id="cardImage2" src={image3} alt=""/>
      ...
      <div className="cards-list grid cols-lg-3 cols-md-2 cols-sm-2">
    <div className="card-item flex"/>
      <p className="card-desc" id="paragraph2">Attendees will have the opportunity to log in and have all the information of the event in one page, And 
